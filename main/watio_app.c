...
static int parse_json_response(const cJSON *json_response, price_t **prices, int total_num_prices, int len_new_prices)
{
...
static void watio_app_task(void *pvParameters)
{
    ...
    for (;;)
    {
        ...
        total_num_prices = get_today_prices(&prices);
